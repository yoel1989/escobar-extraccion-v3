...
# Determinar el tipo de PIN basado en el tiempo convertido
        ...
        elif tiempo == "10:00:00" or tiempo.startswith("10:"):
            tipo_pin = "10Horas"
            precio = PRECIOS_PINES["10Horas"]
            comision = COMISIONES_POR_PIN["10Horas"]
        else:
...
# Tipos de PIN en el orden específico
    tipos_pin_orden = ["1Hora", "3Horas", "5Horas", "10Horas"]
...
async def main():
    ...
    if mensajes:
        ...
        print("=" * 60)
        for tipo_pin in ["1Hora", "3Horas", "5Horas", "10Horas"]:
