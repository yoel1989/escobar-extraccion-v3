...
def calcular_ventas_y_comisiones(datos):
    ...
    total_valor = 0
    total_comision = 0
    cobro_fijo_tv = 25000  # Cobro fijo de Television
...
# Calcular comisión por alcanzar metas
    ...
    # Sumar cobro fijo de televisión al valor total
    total_con_tv = total_valor + cobro_fijo_tv
    total_a_enviar = total_con_tv - total_comision - comision_alcanza
    
    return {
        'ventas_por_tipo': ventas_por_tipo,
        'total_ventas': total_ventas,
        'total_valor': total_valor,
        'total_con_tv': total_con_tv,
        'cobro_fijo_tv': cobro_fijo_tv,
...
# Línea de totales
    ...
    # Cobro fijo de televisión
    tabla_resumen.append(['', '', 'TELEVISION', f"$ {ventas_calculadas['cobro_fijo_tv']:,}"])
    
    # Total con televisión
    tabla_resumen.append(['', '', 'TOTAL CON TV', f"$ {ventas_calculadas['total_con_tv']:,}"])
...
async def main():
    ...
    if mensajes:
        ...
        print(f"   TELEVISION: ${ventas['cobro_fijo_tv']:,}")
        print(f"   TOTAL CON TV: ${ventas['total_con_tv']:,}")
