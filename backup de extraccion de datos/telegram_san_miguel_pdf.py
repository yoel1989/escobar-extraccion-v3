...
# Para tiempos largos, asignar categorías
        ...
        elif total_horas >= 24 * 15:  # 15 días o más
            return "360:00:00"  # 15 días en horas
...
def calcular_ventas_y_comisiones(datos):
    ...
    for item in datos:
        ...
        elif tiempo == "360:00:00" or (tiempo.startswith("360:") or int(tiempo.split(':')[0]) >= 24 * 15):
            tipo_pin = "15Dias"
...
def crear_tabla_resumen(ventas_calculadas, fecha_inicio, fecha_fin, nombre_sitio):
  ...
  # Tipos de PIN en el orden específico
    tipos_pin_orden = ["1Hora", "2Horas", "3Horas", "1Dia", "15Dias", "30Dias"]
...
async def main():
    ...
    if mensajes:
        ...
        print("=" * 60)
        for tipo_pin in ["1Hora", "2Horas", "3Horas", "1Dia", "15Dias", "30Dias"]:
