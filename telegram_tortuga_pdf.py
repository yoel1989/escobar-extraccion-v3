...
def calcular_ventas_y_comisiones(datos):
    ...
    total_valor = 0
    total_comision = 0
    cliente_conductor_valor = 40000  # Valor fijo de cliente conductor
    cliente_conductor_comision = 5000  # Comisión fija de cliente conductor
...
# Calcular comisión por alcanzar metas
    ...
    # Sumar cliente conductor al total
    total_con_conductor = total_valor + cliente_conductor_valor
    total_comision_con_conductor = total_comision + cliente_conductor_comision
    total_a_enviar = total_con_conductor - total_comision_con_conductor - comision_alcanza
    
    return {
        'ventas_por_tipo': ventas_por_tipo,
        'total_ventas': total_ventas,
        'total_valor': total_valor,
        'cliente_conductor_valor': cliente_conductor_valor,
        'total_con_conductor': total_con_conductor,
        'cliente_conductor_comision': cliente_conductor_comision,
        'total_comision_con_conductor': total_comision_con_conductor,
...
# Cliente conductor
    tabla_resumen.append(['', '', 'CLIENTE CONDUCTOR', f"$ {ventas_calculadas['cliente_conductor_valor']:,}"])
...
async def main():
    ...
    if mensajes:
        ...
        print(f"   CLIENTE CONDUCTOR: ${ventas['cliente_conductor_valor']:,}")
        print(f"   TOTAL CON CONDUCTOR: ${ventas['total_con_conductor']:,}")
        print(f"   COMISION CONDUCTOR: ${ventas['cliente_conductor_comision']:,}")
        print(f"   TOTAL COMISIONES: ${ventas['total_comision_con_conductor']:,}")
