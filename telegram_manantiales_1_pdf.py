...
def calcular_ventas_y_comisiones(datos):
    ...
    for item in datos:
        ...
        elif tiempo == "05:00:00" or tiempo.startswith("05:"):
            tipo_pin = "5Horas"
            precio = PRECIOS_PINES["5Horas"]
            comision = COMISIONES_POR_PIN["5Horas"]
...
def crear_tabla_resumen(ventas_calculadas, fecha_inicio, fecha_fin, nombre_sitio):
  ...
  # Tipos de PIN en el orden específico
    tipos_pin_orden = ["1Hora", "2Horas", "3Horas", "5Horas", "1Dia", "30Dias"]
...
# Forzar el nombre del sitio para manantiales-1
    nombre_sitio = "MANANTIALES"
    if datos:
        # Buscar el primer mensaje que tenga ubicación válida (como fallback)
        for item in datos:
...
async def main():
    ...
    if mensajes:
        ...
        print(f"\nRESUMEN FINANCIERO:")
        print("=" * 60)
        for tipo_pin in ["1Hora", "2Horas", "3Horas", "5Horas", "1Dia", "30Dias"]:
