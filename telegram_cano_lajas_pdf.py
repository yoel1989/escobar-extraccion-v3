...
def calcular_comision_alcanzada(total_ventas):
...
def calcular_ventas_y_comisiones(datos):
    ...
    comision_alcanzada = calcular_comision_alcanzada(total_valor)
    total_a_enviar = total_valor - total_comision - comision_alcanzada
    ...
    return {
        ...
        'comision_alcanzada': comision_alcanzada,
...
def crear_tabla_resumen(ventas_calculadas, fecha_inicio, fecha_fin, nombre_sitio):
  ...
  # Tipos de PIN en el orden específico
    tipos_pin_orden = ["1Hora", "3Horas", "1Dia", "30Dias"]
    ...
    tabla_resumen.append(['', '', 'COMISION ALCANZADA', f"$ {ventas_calculadas['comision_alcanzada']:,}"])
...
async def main():
    ...
    if mensajes:
        ...
        print(f"   COMISIÓN ALCANZA: ${ventas['comision_alcanzada']:,}")
